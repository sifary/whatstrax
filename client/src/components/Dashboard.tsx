...
import { Eye, EyeOff, Plus, Trash2, Zap, Settings } from "lucide-react";
...
export function Dashboard({ connectionState }: DashboardProps) {
  ...
  const [selectedPlatform] = useState<Platform>("whatsapp");
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
        ...
        <div className="flex gap-4">
          <input
            type="text"
            placeholder="Enter WhatsApp number (e.g. 491701234567)"
